            ...
            var i = function(p, fc) {
                ...
                if (r) {
                    ...
                    if (mb) {
                        cc = mb.wg;
                        rb = mb.J;
                        ib = u == 1 && r > 1 && rb && (!b.pd() || b.vd() >= 8)
                    }
                    kb = ib || u >= r || !(D & 1) ? 0 : a.id;
                    X = (u > 1 || kb ? fb : -1) & a.hd;
                    var Gb = v,
                        C = [],
                        A, L, Db = b.Hf(),
                    ...
                    a.Ub && b.a(g, "keydown", function(b) {
                        if (b.keyCode == 37) ab(-a.Ub);
                        else b.keyCode == 39 && ab(a.Ub)
                    });
                    var pb = a.Tb;
