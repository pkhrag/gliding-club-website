...
(function(h, f, c, j, d, l, k) { /*! Jssor */
            ...
            var b = new function() {
                ...
                function Ib() {
                    if (!G) {
                        G = {
                            Ue: "ontouchstart" in h || "createTouch" in f
                        };
                        var a;
                        if (I.pointerEnabled || (a = I.msPointerEnabled)) G.Zc = a ? "msTouchAction" : "touchAction"
                    }
                    return G
                }
                ...
                g.Wc = Y;
                g.eb = function(a) {
                    if (g.De(a)) a = f.getElementById(a);
                    return a
                };
                ...
                function M(d, a) {
                    ...
                    if (a) {
                        ...
                        if (J()) {
                            if (a.ab || a.V || a.P) c += " translate3d(" + (a.ab || 0) + "px," + (a.V || 0) + "px," + (a.P || 0) + "px)";
                            if (a.n == k) a.n = 1;
                            if (a.m == k) a.m = 1;
                            if (a.n != 1 || a.m != 1) c += " scale3d(" + a.n + ", " + a.m + ", 1)"
                        }
                    }
                    d.style[K(d)] = c
                }
                g.Qc = m("transformOrigin", 4);
                g.ve = m("backfaceVisibility", 4);
                g.ue = m("transformStyle", 4);
                g.te = m("perspective", 6);
                g.se = m("perspectiveOrigin", 4);
                g.re = function(a, b) {
                ...
                g.Ad = function(d, a) {
                    if (a) d.style.clip = "rect(" + c.round(a.j || a.p || 0) + "px " + c.round(a.u) + "px " + c.round(a.r) + "px " + c.round(a.k || a.q || 0) + "px)";
                    else if (a !== k) {
                ...
                g.Ed = function(a, b) {
                    var c = g.wc(a);
                    b & 1 && g.v(a, (g.i(c) - g.i(a)) / 2);
                    b & 2 && g.z(a, (g.l(c) - g.l(a)) / 2)
                };
                g.ce = function(b, a) {
                ...
                g.Xd = function(a, g, i, h) {
                    if (h) a = W(a);
                    var c = S(a, g);
                    if (!c.length) c = b.Pe(a, g);
                ...
                g.Ie = function(l, m, x, q, z, A, n) {
                    ...
                    if (a.c && b.kd() && !a.c.j && !a.c.k && !a.c.p && !a.c.q && a.c.u == n.bb && a.c.r == n.Z) a.c = j;
                    return a
                }
            };
            ...
            var i = function(p, fc) {
                ...
                function xc(o, f) {
                    ...
                    function E(a) {
                        ...
                        T(o, a, 0);
                        F = d;
                        r = new I.L(o, I, b.be(b.g(o, "idle")) || lc);
                        r.M(0)
                    }
                ...
                function vc(y, f, p, q) {
                    ...
                    a.rd = function() {
                        A && A.W == f && A.Cb();
                        var b = a.pb();
                        b < c && g.f(i.Tc, f, -b - 1, n, j, e, c)
                    };
                    a.id = function(a) {
                        p && b.fb(lb, a && p.vc.We ? "" : "hidden")
                    };
                    a.ic = function(b, a) {
                        if (k && a >= h) {
                            k = l;
                        ...
                        g.f(i.Ke, f, a, n, j, e, c)
                    };
                    a.bd = function(a) {
                        if (a && !t) {
                            t = a;
                            a.mb($JssorPlayer$.Td, x)
                        }
                    };
                    p && a.dc(p);
                    h = a.Sb();
                ...
                if (q) {
                    ...
                    if (mb) {
                        cc = mb.Ze;
                        rb = mb.L;
                        ib = u == 1 && q > 1 && rb && (!b.ed() || b.hd() >= 8)
                    }
                    kb = ib || u >= q || !(D & 1) ? 0 : a.Rb;
                    X = (u > 1 || kb ? fb : -1) & a.Fc;
                    var Gb = v,
                        C = [],
                        A, L, Db = b.Fe(),
                        ob = Db.Ue,
                        G, qb, Ib, sb;
                    Db.Zc && b.Q(Gb, Db.Zc, ([j, "pan-y", "pan-x", "none"])[X] || "");
                    U = new zc;
            ...
            var s = function(a, g, h) {
                    ...
                    c.Nb = function(c) {
                        ...
                        e = 0;
                        if (!m) {
                            b.a(a, "click", b.D(j, k, -i));
                            b.a(g, "click", b.D(j, k, i));
                            b.Kb(a);
                            b.Kb(g);
                            m = d
                        }
                    ...
                    if (f.rb) {
                        b.s(a, "autocenter", f.rb);
                        b.s(g, "autocenter", f.rb)
                    }
                },
                q = function(g, B) {
                    var h = this,
                    ...
                    function A(n, f) {
                        ...
                        g.yc = q;
                        l = n.zd || n.ad || b.T();
                        g.Fb = c = b.Xd(k, "thumbnailtemplate", l, d);
                        m = b.Kb(c);
                        a.ec & 1 && b.a(c, "click", b.D(j, i, 0));
                        a.ec & 2 && b.a(c, "mouseover", b.Wb(b.D(j, i, 1), c))
                    }
                    h.jc = function(b, d, f) {
                        var a = p;
                        p = b;
